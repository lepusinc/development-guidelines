...
- Delegate branch coverage and boundary-value verification of individual logic to unit tests; feature tests focus on the happy path and representative error cases (e.g., typical error responses or a command's abnormal exit).
